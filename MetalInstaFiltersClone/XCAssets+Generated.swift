...
internal enum Assets {
  internal enum Main {
    ...
    internal static let newYork = ImageAsset(name: "new york")
  }
  internal enum Shaders {
    internal enum LUTs {
    ...
    internal enum Overlays {
      ...
      internal static let filter2 = ImageAsset(name: "filter2")
      internal static let hefe = ImageAsset(name: "hefe")
      internal static let hudson = ImageAsset(name: "hudson")
      internal static let picture3 = ImageAsset(name: "picture3")
      internal static let toaster = ImageAsset(name: "toaster")
    }
  }
}
